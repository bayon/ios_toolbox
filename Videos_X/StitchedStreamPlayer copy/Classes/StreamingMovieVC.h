...
@class AVPlayer;
@class AVPlayerItem;
@class PlayerLayerXView;

@interface StreamingMovieVC : UIViewController <UITextFieldDelegate> {
	NSURL *movieURL;
	AVPlayer *player;
	AVPlayerItem *playerItem;
	PlayerLayerXView *playerLayerXView;
...
@property (retain) IBOutlet PlayerLayerXView *playerLayerXView;
