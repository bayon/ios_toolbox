...
#import "PlayerLayerXView.h"

#import <AVFoundation/AVFoundation.h>

static void *SMVC_TimedMetadataObserverContext = &SMVC_TimedMetadataObserverContext;
static void *SMVC_RateObservationContext = &SMVC_RateObservationContext;
static void *SMVC_CurrentItemObservationContext = &SMVC_CurrentItemObservationContext;
static void *SMVC_PlayerItemStatusObserverContext = &SMVC_PlayerItemStatusObserverContext;
...
#pragma mark -
@interface StreamingMovieVC (Player)
...
@implementation StreamingMovieVC

@synthesize movieURLTextField;
@synthesize movieTimeControl;
@synthesize playerLayerXView;
...
{
	/* user presses return, keyboard is dismissed. */
...
@implementation StreamingMovieVC (Player)
...
- (void)prepareToPlayAsset:(AVURLAsset *)asset withKeys:(NSArray *)requestedKeys
{
    ...
    [self.playerItem addObserver:self 
                      forKeyPath:kStatusKey 
                         ...
                         context:SMVC_PlayerItemStatusObserverContext];
                       ...
                       context:(void*)context
{
	...
	if (context == SMVC_PlayerItemStatusObserverContext)
	{
		[self syncPlayPauseButtons];
        ...
        switch (status)
        {
            ...
            case AVPlayerStatusReadyToPlay:
            {
                ...
                playerLayerXView.playerLayer.hidden = NO;
                ...
                playerLayerXView.playerLayer.backgroundColor = [[UIColor blackColor] CGColor];
                
                /* Set the AVPlayerLayer on the view to allow the AVPlayer object to display
                 its content. */	
                [playerLayerXView.playerLayer setPlayer:player];
	...
	else if (context == SMVC_RateObservationContext)
	{
        [self syncPlayPauseButtons];
	}
	/* AVPlayer "currentItem" property observer. 
     ...
     replacement will/did occur. */
	else if (context == SMVC_CurrentItemObservationContext)
	{
        ...
        else /* Replacement of player currentItem has occurred */
        {
            ...
            [playerLayerXView.playerLayer setPlayer:self.player];
            
            /* Specifies that the player should preserve the video’s aspect ratio and 
             fit the video within the layer’s bounds. */
            [playerLayerXView setVideoFillMode:AVLayerVideoGravityResizeAspect];
	...
	/* Observe the AVPlayer "currentItem.timedMetadata" property to parse the media stream 
     timed metadata. */
	else if (context == SMVC_TimedMetadataObserverContext)
	{
